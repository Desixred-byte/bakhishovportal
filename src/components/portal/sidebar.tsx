...
const navItems = [
  { key: "dashboard", href: "/portal", icon: House },
  { key: "smm", href: "/portal/smm", icon: SpeakerHigh },
  { key: "deliverables", href: "/portal/deliverables", icon: FolderOpen },
  { key: "invoices", href: "/portal/invoices", icon: Receipt },
  { key: "contact", href: "/portal/contact", icon: Lifebuoy },
...
const sidebarCopy: Record<PortalLanguage, Record<string, string>> = {
  ...
  az: {
    ...
    overview: "Ümumi",
    smm: "SMM",
    deliverables: "Təhvil verilənlər",
    invoices: "Fakturalar",
    contact: "Əlaqə",
